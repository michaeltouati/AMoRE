...
Thank you very much for your interest in contributing to [AMoRE](https://github.com/michaeltouati/AMoRE). In the following can be found how to :
- report a bug you faced when compiling or using [AMoRE](https://github.com/michaeltouati/AMoRE)
- propose new features that would make [AMoRE](https://github.com/michaeltouati/AMoRE) better
...
1) Go to ['Issues'](https://github.com/michaeltouati/AMoRE/issues) on the [AMoRE master branch](https://github.com/michaeltouati/AMoRE) 
...
If you want to propose a new feature in [AMoRE](https://github.com/michaeltouati/AMoRE) that is not already in the perspectives of the code mentioned in the last section of the documentation [esvm.pdf](https://github.com/michaeltouati/ESVM/blob/master/esvm.pdf), follow these steps :
1) Go to ['Issues'](https://github.com/michaeltouati/AMoRE/issues) on the [AMoRE master branch](https://github.com/michaeltouati/AMoRE)
...
1) Fork the repo and create your own branch from the [AMoRE 'master' branch](https://github.com/michaeltouati/AMoRE).
...
# License
When you submit code changes, your submissions are understood to be under the same [GPLv3](https://www.gnu.org/licenses/gpl-3.0.en.html) that covers [AMoRE](https://github.com/michaeltouati/ESVM). 
