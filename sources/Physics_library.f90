...
module physics_library
  ...
  elemental function omega_pe(Z, ni, Te)
    ...
    real(PR), intent(in) :: Z, ni, Te
    real(PR)             :: omega_pe
    omega_pe = sqrt(4._PR * pi * Zeff(Z,ni,Te) * ni * (e**2._PR) / me)
  ...
  elemental function lambda_Debye_e(Z, ni, Te)
    ...
    lambda_Debye_e = (4._PR * pi * zeff(Z, ni, Te) * ni * e**2._PR /&
  ...
  elemental function lambda_Debye(Z, ni, Te, Ti)
    ...
    & +  (4._PR * pi * zeff(Z, ni, Te) * ni * e**2._PR /(kB*Ti)  ) )**(-0.5_PR) 
  ...
  elemental function lambda_i(ni)
    ...
    real(PR)             :: lambda_i
    lambda_i = (3._PR / (4._PR * pi *ni))**(1._PR/3._PR)
  ...
  elemental function lambda_e(Z, ni, Te)
    ...
    real(PR), intent(in) :: Z, ni, Te
    real(PR)             :: lambda_e
    lambda_e = (3._PR / (4._PR * pi * Zeff(Z, ni, Te) * ni))**(1._PR/3._PR)
  ...
  elemental function log_rel_ei(Z, ni, Te, Ti, nrj)
    ...
    log_rel_ei = 0.5_PR * log(1._PR + (bmax**2._PR / bmin**2._PR))
  ...
  elemental function Chemical_potential(Z, ni, Te)
    ...
    yy=y**(-2._PR/3._PR)
    R_m= ( c0 + (c1*yy) + (c2*(yy**2._PR)) + (c3*(yy**3._PR)) +&
    &     (c4*(yy**4._PR)) + (c5*(yy**5._PR)) + (c6*(yy**6._PR)) ) / &
