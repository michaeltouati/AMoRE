...
plt.plot(T, U_EL_n,'green',linewidth=2,label=r'$U_{E}\times$'+f"{C_EL:.0E}")
plt.plot(T, U_MA_n,'cyan',linewidth=2,label=r'$U_{B}\times$'+f"{C_MA:.0E}")
plt.plot(T, U_E,'red',linewidth=2,label=r'$U_\mathrm{inj}$')
plt.plot(T, U_B,'black',linewidth=2,label=r'$U_b$')
plt.plot(T, U_Dcol,'magenta',linewidth=2,label=r'$U_{d,\mathrm{col}}$')
plt.plot(T, U_Dres,'blue',linewidth=2,label=r'$U_{d,\mathrm{res}}$')
plt.plot(T, U_stot,'red',linestyle='--',linewidth=2,label=r'$U_\mathrm{esc}$')
