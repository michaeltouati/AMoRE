...
DEPS_DS_LBL   = r'$d \varepsilon / d s \,(\mathrm{keV}/\mu\mathrm{m})$'
TTL           = 'Beam electrons stopping power'
FIG_FILE      = MAT_DIR+'dE_ds.png'
lib.make_scalar_plot_figure(xplot     = EPS,
                            yplot     = DEPS_DS,
                            color     = 'red',
                            xplot_min = EPS_MIN,
                            xplot_max = EPS_MAX,
...
lib.make_scalar_plot_figure(xplot     = TE,
                            yplot     = ZF,
                            color     = 'red',
                            xplot_min = TE_MIN,
                            xplot_max = TE_MAX,
