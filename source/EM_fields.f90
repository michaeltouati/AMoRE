...
!$omp  PARALLEL DO DEFAULT(SHARED) PRIVATE(i,k,Bcour,Bres,Bcross,&
!$omp& eta_i_k, eta_im1_k, eta_ip1_k, eta_i_km1, eta_i_kp1,&
!$omp& ne_i_k, ne_i_km1, ne_i_kp1, ne_im1_k, ne_ip1_k) COLLAPSE(2)
do k = 2,N_z-1,1
do i=2,N_x-1,1   
...
!$omp  PARALLEL DO DEFAULT(SHARED) PRIVATE(i, k, eta_temp, ne, Pe_mup1, Pe_mum1,&
!$omp& Excour, Ezcour, Expres, Ezpres) COLLAPSE(2)
do k= 2,N_z-1,1
do i=2,N_x-1,1
! Temporary values
